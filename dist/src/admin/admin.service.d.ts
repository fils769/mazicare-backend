...
export declare class AdminService {
    ...
    constructor(prisma: PrismaService, activityLogService: ActivityLogService, configService: ConfigService);
    getActivityLogs(filters: AdminActivityQueryDto): Promise<any>;
    ...
    private calculateSubscriptionProgress;
    private aggregateStringGenderCounts;
    private aggregateEnumGenderCounts;
}
