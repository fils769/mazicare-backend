...
const activity_listeners_1 = require("./activity.listeners");
...
exports.ActivityModule = ActivityModule = __decorate([
    (0, common_1.Module)({
        providers: [activity_log_service_1.ActivityLogService, activity_listeners_1.ActivityListeners, prisma_service_1.PrismaService],
